...
/**
 * Lightweight {@code GET /health} probe ({@code { status, version, uptime }}) used as the Docker
 * HEALTHCHECK target — the deeper DB-aware checks live on the private Actuator management port.
 */
@RestController
